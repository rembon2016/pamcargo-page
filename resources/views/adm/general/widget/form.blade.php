        ...
        <div class="col-12">
            <div class="card shadow mb-4">
                <div class="card-header d-flex justify-content-between align-items-center py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Widget Quick Access Form</h6>
                    <a href="{{ route('admin.general.widget.index') }}" class="btn btn-danger btn-sm">
                ...
                <div class="card-body">
                    <form action="{{ $actions['url'] }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="10" class="form-control summernotes" data-placeholder="" name="description" required>{{ old('description', @$widget->title) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">
